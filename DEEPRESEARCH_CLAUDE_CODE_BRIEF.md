...
An agentic research assistant API that lets users discover, save, and chat with academic papers. Three Gemini LLM agents work together: one classifies and optimises search queries, one summarises papers, and one powers multi-turn conversations about saved papers.
...
├── test_health.py
├── test_papers.py                   # 16 tests: CRUD + PDF extraction + summary on save
...
- No auth, rate limiting, frontend, Docker, or deployment needed
